...
tasks.jar {
	manifest {
		attributes(mapOf(
				...
				"Automatic-Module-Name" to "com.elex_project.cyclops"
		))
	}
}
...
publishing {
	publications {
		create<MavenPublication>("mavenJava") {
			...
			pom {
				...
				url.set("https://github.com/elex-project/cyclops")
				...
				licenses {
					license {
						...
						url.set("https://github.com/elex-project/cyclops/blob/main/LICENSE")
					}
				}
				developers {
					developer {
				...
				scm {
					connection.set("scm:git:https://github.com/elex-project/cyclops.git")
					developerConnection.set("scm:git:https://github.com/elex-project/cyclops.git")
					url.set("https://github.com/elex-project/cyclops")
				}
			}
		}
	...
	repositories {
		...
		maven {
			name = "mavenGithub"
			url = uri("https://maven.pkg.github.com/elex-project/cyclops")
			credentials {
